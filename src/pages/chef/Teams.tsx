...
import {
  ManagerInputsSchema,
  NewCashierInputsSchema,
  NewTerminalInputsSchema,
  WaiterInputsSchema,
          ...
          <div className="w-full px-6 py-4">
            ...
            <div className="text-nowrap pb-2 flex flex-row flex-nowrap justify-start items-center gap-x-8 overflow-x-auto">
              <div className="flex flex-row items-center justify-start gap-x-1">
                ...
                <button
                  className={`text-2xl size-9 rounded-full ${
                    selectedView === "manager"
                      ? "primary_bg_color text-white"
                      : "bg-[#EDECEC] text-black"
                  }`}
              ...
              <div className="flex flex-row items-center justify-start gap-x-1">
                <button
                  ...
                  onClick={() => setSelectedView("waiter")}
                >
                  Waiter
                </button>
              ...
              <div className="flex flex-row items-center justify-start gap-x-1">
                <button
                  ...
                  onClick={() => setSelectedView("terminals")}
                >
                  Terminals
                </button>
